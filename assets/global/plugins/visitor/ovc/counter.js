...
function createOnlineVisitorsCounterElement()
{
    ...
    if (existingElement === null) // Only creates a new element if does not exist yet.
    {
        ...
        button.style.cssText = 'z-index: 100;position: fixed;bottom: 5px;left: 10px;background-color: #f7f7f7;border-radius: 28px;border: 2px solid rgb(53 45 44);display: inline-block;cursor: pointer;color: rgb(20 21 23);font-family: "Trebuchet MS";font-size: 10px;padding: 4px 8px;text-decoration: none;';
