<?php  $string ="<div class=\"header-content\">
<h2><i class=\"fa fa-home\"></i>".$judul." <span></span></h2>
...
<li class=\"nav-border nav-border-top-danger\"><a href=\"#detail\" aria-controls=\"detail\" role=\"tab\" data-toggle=\"tab\">Detail ".$judul."</a></li>
<li class=\"active nav-border nav-border-top-danger\"><a href=\"#daftar\" aria-controls=\"daftar\" role=\"tab\" data-toggle=\"tab\">Daftar ".$judul."</a></li>
</ul>
</div>
...
foreach ($all as $row) {
  $string .= "\n\t\t<option value='".strtolower($row['column_name'])."'>".($row['COLUMN_COMMENT'])."</option>";
}
$string .="</select>
</div>
<div class=\"col-sm-6\">
...
foreach ($all as $row) {
  $string .= "\n\t\t<th>" . label($row['COLUMN_COMMENT']) . "</th>";
}
$string .= "\n\t\t</tr>
</thead>
<tbody></tbody>
...
<p>Yakin hapus Data ".$judul." dengan nomor <strong><span id=\"hps_id\"></span></strong>?</p>
<p class=\"text-right\">
