    ...
    <form action="<?php echo $action; ?>" class="form-horizontal form-bordered" method="post">
      <div class="form-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-5">
            <input type="text" class="form-control required" name="subktg_id" id="subktg_id" value="<?php echo $subktg_id; ?>" />
          </div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label text-left">Kategori</label>
          <div class="col-sm-5">
            <select class="form-control required kategoris2" name="ktg_id" id="ktg_id">
              <option value="<?php echo $ktg_id; ?>"><?= $ktg_name ?></option>
            </select>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-5">
            <input type="text" class="form-control required" name="subktg_name" id="subktg_name" value="<?php echo $subktg_name; ?>" />
          </div>
        </div>
      </div>
    </form>
