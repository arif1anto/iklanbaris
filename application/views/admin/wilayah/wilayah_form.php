  ...
  <div class="panel-body no-padding rounded-bottom">
	...
	<div class="form-group">
            ...
            <div class="col-sm-5">
              <input type="text" class="form-control required" name="wil_id" id="wil_id" value="<?php echo $wil_id; ?>" />
            </div>
        </div>
	<div class="form-group">
            <label class="col-sm-2 control-label text-left">Nama Wilayah</label>
            <div class="col-sm-5">
              <input type="text" class="form-control required" name="wil_name" id="wil_name" value="<?php echo $wil_name; ?>" />
            </div>
        </div>
	</div>
    </form>
