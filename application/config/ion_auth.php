...
$config['tables']['users_data']      = 'users_data';
...
$config['join']['app_groups'] = 'group_id';
 ...
 */
$config['site_title']                 = "futsal web apps";       // Site Title, example.com
$config['admin_email']                = "kusniawan.sisteminformasi@gmail.com"; // Admin Email, admin@example.com
 ...
 */
$config['email_register'] = 'register.php';
